...
var scores, roundScore, previousRoundScore, activePlayer, gamePlaying;
...
document.querySelector('.btn-roll').addEventListener('click', function() {
    ...
    if(gamePlaying) {
        ...
        if (dice !== 1 && !((dice === 2||dice ===4||dice === 6) && (previousRoundScore === 2||previousRoundScore === 4||previousRoundScore ===6))) {
            //Add score
            roundScore += dice;
            document.querySelector('#current-' + activePlayer).textContent = roundScore;
            previousRoundScore = dice;

        } else if ((dice === 2||dice ===4||dice === 6) && (previousRoundScore === 2||previousRoundScore === 4||previousRoundScore ===6)) {
            console.log('Dice: ' + dice + ' previous Dice: ' + previousRoundScore);
